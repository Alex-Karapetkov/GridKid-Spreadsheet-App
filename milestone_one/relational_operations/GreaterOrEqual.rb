...
class GreaterOrEqual
    ...
    # constructs an unevaluated form of the relational greater than or equal expression
    ...
    # evaluates the relational greater than or equal to expression
    ...
    # generate string representation of the relational greater than or equal to expression
    def to_s
...
compare = GreaterOrEqual.new(intOne, intOne)
puts compare
puts compare.evaluate(environment)

compare = GreaterOrEqual.new(intTwo, intOne)
puts compare
puts compare.evaluate(environment)

compare = GreaterOrEqual.new(floatOne, floatTwo)
puts compare
puts compare.evaluate(environment)

compare = GreaterOrEqual.new(floatTwo, floatOne)
puts compare
puts compare.evaluate(environment)

compare = GreaterOrEqual.new(stringOne, stringTwo)
puts compare
puts compare.evaluate(environment)

compare = GreaterOrEqual.new(stringTwo, stringOne)
puts compare
puts compare.evaluate(environment)

# error
error = 0.1
compare = GreaterOrEqual.new(error, floatTwo)

# TypeError
compare = GreaterOrEqual.new(stringOne, floatOne)
puts compare
puts compare.evaluate(environment)
=end