...
class BitwiseOr
    ...
    # constructs an unevaluated form of the bitwise or expression
    ...
    # evaluates the bitwise or expression
    ...
    # generate string representation of the bitwise or expression
    def to_s
...
sum = BitwiseOr.new(a, b)
puts sum
puts sum.evaluate(environment)

# error
a = 1
error = BitwiseOr.new(a, b)
error = BitwiseOr.new(b, a)

# another error
boolean = BooleanPrimitive.new(true)
error = BitwiseOr.new(boolean, b)
=end