...
class LessThan
    ...
    # constructs an unevaluated form of the relational less than expression
    ...
    # evaluates the relational less than expression
    ...
    # generate string representation of the relational less than expression
    def to_s
...
compare = LessThan.new(intOne, intTwo)
puts compare
puts compare.evaluate(environment)

compare = LessThan.new(intTwo, intOne)
puts compare
puts compare.evaluate(environment)

compare = LessThan.new(floatOne, floatTwo)
puts compare
puts compare.evaluate(environment)

compare = LessThan.new(floatTwo, floatOne)
puts compare
puts compare.evaluate(environment)

compare = LessThan.new(stringOne, stringTwo)
puts compare
puts compare.evaluate(environment)

compare = LessThan.new(stringTwo, stringOne)
puts compare
puts compare.evaluate(environment)

# error
error = 1
compare = LessThan.new(stringTwo, error)

# TypeError
compare = LessThan.new(stringTwo, floatTwo)
puts compare
puts compare.evaluate(environment)
=end